...
let n1 =parseInt(PMPT("Please enter you First Number: "));/* Enter Your First Numeric value*/
let n2 =parseInt(PMPT("Please enter you Second Number:"));/* Enter Your Second Numeric value*/
let OP =PMPT("please enter your Operator (+,-,*,/):");
/* Nested IF use*/
if (OP=='+')
{
